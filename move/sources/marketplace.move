...
fun init(ctx: &mut TxContext) {
    ...
    // Transfer it to the module publisher (ctx.sender()) using transfer::transfer() function
...
public fun buy_hero(list_hero: ListHero, coin: Coin<SUI>, ctx: &mut TxContext) {
    ...
    // Get the list hero ID before deleting
...
public fun delist(_: &AdminCap, list_hero: ListHero) {
    ...
    // Implement admin delist functionality
